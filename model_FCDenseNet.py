from keras.layers import Activation, MaxPooling2D, UpSampling2D, Dense, BatchNormalization, Input, Reshape, multiply, \
    add, Dropout, AveragePooling2D, GlobalAveragePooling2D, concatenate
